      ...
      <div className="container " style={{ paddingTop: '50px' }}>
        ...
        <div >
          <Row className='testimonials-row'>
            <Col>
              <Card style={{ boxShadow: '0px 2px 10px rgba(0, 0, 0, 0.3)', marginBottom: "25px" }}>
                <Card.Body>
                  <Row>
                    <Col xs={3}>
                      <div className='mb-3'>
                  ...
                  <Row>
                    <Col>
                      <p>
                        ...
                        represents the content of the second row in the card. This
                        is a paragraph that represents the content of the second
                        row in the card. This is a paragraph that represents the
                        content of the second row in the card. This is a paragraph
                        that represents the content of the second row in the card.
                      </p>
                    </Col>
                  </Row>
                </Card.Body>
